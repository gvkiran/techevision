// TecheVision — job board (search, filter, detail view, apply modal)
(function () {
  ...
  function fill(sel, values) { values.sort().forEach(function (v) { var o = document.createElement('option'); o.value = v; o.textContent = v; sel.appendChild(o); }); }
  ...
  // ---- Apply modal (closes ONLY via the X) ----
  ...
  // Any Apply trigger (cards, detail, "send resume anyway") opens the apply modal
